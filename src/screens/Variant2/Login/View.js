    ...
    return (
        <View style={screenStyles.container}>
            ...
            <View style={[screenStyles.bottomContainer]}>
                ...
                <Text
                    style={screenStyles.subtitleText}>{"Welcome to the top-ranked Liquor app for Android and IOS, where we take pride in our reliable and timely delivery of all your liquor needs."}</Text>
