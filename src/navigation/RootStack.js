...
import {Platform,LayoutAnimation, BackHandler,Appearance } from 'react-native';
...
import { OrderCancelled } from '../screens/OrderCancelled/View';
import { OrderTrack } from '../screens/OrderTrack/View';
import { AddressCheck } from '../screens/AddressCheck/View';
import { GiftDetails } from '../screens/GIftDetails/View';
...
import { CartStack } from '../screens/CartStack/View';
...
export function RootStack() {
    ...
    if (Platform.OS == "ios") {
        GoogleSignin.configure({
            iosClientId: '62455514535-voor9cr33juf9sa7i3a6lb2a4pso4v13.apps.googleusercontent.com',
        });
    } else {
         GoogleSignin.configure({
...
//            initialRouteName={Config.SELECTED_VARIANT}
            initialRouteName={Routes.LOGIN_FORM_SCREEN3}
            screenOptions={{
            ...
            <Stack.Screen name={Routes.CART_STACK} component={CartStack}/>
            ...
            <Stack.Screen name={Routes.ORDER_CANCELLED} component={OrderCancelled}/>
            <Stack.Screen name={Routes.ORDER_TRACK} component={OrderTrack}/>
...
function BottomTabsVariant3() {
    ...
    return (
        <Tab.Navigator screenOptions={{headerShown: false}} tabBar={props => <Variant3BottomTabBar {...props} style={{display: contextData.stateData.common.isTabBarVisible?"flex":"none"}} />}>
            ...
            {(userId != -1) &&<Tab.Screen name={Routes.FAVOURITES_STACK} component={FavouritesStack} options={{unmountOnBlur: true}}/>}
            ...
            <Tab.Screen name={Routes.CART_STACK} component={CartStack} options={{unmountOnBlur: true}}/>
        </Tab.Navigator>
    );
}
